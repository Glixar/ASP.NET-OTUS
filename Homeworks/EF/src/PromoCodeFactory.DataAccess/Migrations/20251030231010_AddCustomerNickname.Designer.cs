...
namespace PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20251030231010_AddCustomerNickname")]
    partial class AddCustomerNickname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("9c0cbb87-6a1d-45f5-a6e8-9f5d7a2e4b10"),
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.CustomerPreference", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CustomerId = new Guid("9c0cbb87-6a1d-45f5-a6e8-9f5d7a2e4b10"),
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d5e9df5-823f-42d1-a9dd-52e5fef6b8e1"),
                            BeginDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Code = "BOOK15",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                        ...
                        new
                        {
                            Id = new Guid("d52a3a5f-2e0a-4b83-9f5c-1f9c2b5e8fa1"),
                            BeginDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Code = "THEATRE10",
                            CustomerId = new Guid("9c0cbb87-6a1d-45f5-a6e8-9f5d7a2e4b10"),
                            EndDate = new DateTime(2026, 1, 11, 0, 0, 0, 0, DateTimeKind.Utc),
